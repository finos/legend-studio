...
export class XmlModelConnection extends PureModelConnection implements Hashable {
  class: PackageableElementReference<Class>;
  @observable url: string;

  constructor(store: PackageableElementReference<ModelStore>, _class: PackageableElementReference<Class>, url: string) {
    super(store);
    this.class = _class;
    this.url = url;
  }
  ...
  static createUrlStringFromData(data: string): string { return `data:${ContentType.APPLICATION_XML},${tryToMinifyJSONString(data)}` }
