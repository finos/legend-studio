...
import { SetImplementationReference } from 'MM/model/packageableElements/mapping/SetImplementationReference';
...
export class SetImplementationContainer implements Stubable {
  ...
  @action setSetImplementation(value: SetImplementation): void { this.setImplementation.setValue(value) }

  @computed get isStub(): boolean { return !this.setImplementation.value.id }
}
