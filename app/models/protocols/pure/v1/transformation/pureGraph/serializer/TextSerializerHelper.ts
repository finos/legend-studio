...
import { constant, packagePathSerializer } from './CoreSerializerHelper';

export const textSerializationSchema = createSimpleSchema({
  _type: constant(PackageableElementType.TEXT),
  content: primitive(),
  name: primitive(),
