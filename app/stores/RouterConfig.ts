...
export const getSetupRoute = (projectId: string, workspaceId?: string): string => `/${projectId}${workspaceId ? `/${workspaceId}` : ''}`;
export const getEditorRoute = (projectId: string, workspaceId: string): string => `/${projectId}/${workspaceId}/`;
export const getReviewRoute = (projectId: string, reviewId?: string): string => `/review/${projectId}/${reviewId}`;
export const getProjectViewerRoute = (projectId: string): string => `/viewer/${projectId}`;
export const getVersionViewerRoute = (projectId: string, versionId: string): string => `/viewer/${projectId}/version/${versionId}`;
export const getRevisionViewerRoute = (projectId: string, revisionId: string): string => `/viewer/${projectId}/revision/${revisionId}`;
export const getElementViewerRoute = (projectId: string, entityPath: string): string => `/viewer/${projectId}/element/${entityPath}`;
