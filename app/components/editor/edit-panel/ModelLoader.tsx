...
import { ModelLoaderState, MODEL_UPDATER_INPUT_TYPE } from 'Stores/editor-state/ModelLoaderState';
import { FaCaretDown, FaRegSquare, FaCheckSquare, FaTruckLoading } from 'react-icons/fa';
...
export const ModelLoader = observer(() => {
  ...
  // actions
  const loadCurrentProjectEntities = (): void => modelLoaderState.loadCurrentProjectEntities();
        ...
        actions: [
          {
            ...
            handler: (): void => {
              ...
              modelLoaderState.loadModel().catch(applicationStore.alertIllegalUnhandledError);
            },
          },
          {
            label: 'Abort',
  ...
  return (
    <div className="panel model-loader">
      <div className="panel__header model-loader__header">
        <div className="model-loader__header__configs">
          <DropdownMenu
            ...
            content={
              <div className="model-loader__header__configs__types">
                <div className="model-loader__header__configs__type-option__group model-loader__header__configs__type-option__group--native">
                  <div className="model-loader__header__configs__type-option__group__name">native</div>
                  <div className="model-loader__header__configs__type-option__group__options">
                    {nativeInputTypes.map(inputType =>
                      <div key={inputType} className="model-loader__header__configs__type-option__group__option" onClick={setCurrentInputType(inputType)}>
          ...
          >
            <div className="model-loader__header__configs__type">
              <div className="model-loader__header__configs__type__label">
                {currentExternalInputType ? currentExternalInputLabel : prettyCONSTName(currentInputType)}
              </div>
          ...
          <div className="model-loader__header__configs__edit-mode" onClick={toggleReplace}>
      ...
      <div className="panel__content model-loader__editor">
        <TextInputEditor language={EDITOR_LANGUAGE.JSON} inputValue={modelLoaderState.modelText} updateInput={updateModel} showMiniMap={true} />
      </div>
    </div>
  );
});
