...
export const SideBar = observer(() => {
  ...
  const renderSideBar = (): React.ReactNode => {
    switch (editorStore.activeActivity) {
      case ACTIVITY_MODE.EXPLORER: return <Explorer />;
      case ACTIVITY_MODE.CHANGES: return <LocalChanges />;
      case ACTIVITY_MODE.WORKSPACE_REVIEW: return <WorkspaceReview />;
      case ACTIVITY_MODE.WORKSPACE_UPDATER: return <WorkspaceUpdater />;
      case ACTIVITY_MODE.CONFLICT_RESOLUTION: return <ConflictResolution />;
      case ACTIVITY_MODE.PROJECT_OVERVIEW: return <ProjectOverview />;
      case ACTIVITY_MODE.WORKSPACE_BUILDS: return <WorkspaceBuilds />;
      default: return null;
    }
  };
