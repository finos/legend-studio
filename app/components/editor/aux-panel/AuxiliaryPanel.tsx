...
import { MappingIcon } from 'Components/shared/Icon';
...
export const AuxiliaryPanel = observer(() => {
  ...
  const auxTabMap = {
    ...
    [AUX_PANEL_MODE.MAPPING_EXECUTE]: {
      ...
      name: 'EXECUTE',
      icon: <MappingIcon />,
      isVisible: editorStore.currentEditorState
    ...
    [AUX_PANEL_MODE.MAPPING_TEST]: {
      ...
      isVisible: editorStore.currentEditorState
        && editorStore.isInFormMode
        && editorStore.currentEditorState instanceof MappingEditorState
        && editorStore.currentEditorState.currentTabState instanceof MappingTestState,
    },
  ...
  return (
    <div className="panel auxiliary-panel">
      ...
      <div className="panel__content">
        ...
        {isTabVisible(AUX_PANEL_MODE.MAPPING_EXECUTE) && <div className="auxiliary-panel__content__tab"><MappingExecution /></div>}
        {isTabVisible(AUX_PANEL_MODE.MAPPING_TEST) && <div className="auxiliary-panel__content__tab"><MappingTestEditorPanel /></div>}
        {isTabVisible(AUX_PANEL_MODE.DEV_TOOL) && <div className="auxiliary-panel__content__tab"><DevTool /></div>}
      </div>
    </div>
  );
});
