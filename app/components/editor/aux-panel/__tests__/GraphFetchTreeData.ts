                    ...
                    'parameters': [
                      {
                        ...
                        'sourceInformation': {
                          'endColumn': 37,
                          'endLine': 1,
                          'sourceId': 'demo::MyMapping-pureInstanceClassMapping-demo_other_NPerson-fullName--0',
                          'startColumn': 17,
                          'startLine': 1
                        },
                        'values': [
                    ...
                    'parameters': [
                      {
                        ...
                        'sourceInformation': {
                          'endColumn': 5,
                          'endLine': 1,
                          'sourceId': 'demo::MyMapping-pureInstanceClassMapping-demo_other_NPerson-name1--1',
                          'startColumn': 2,
                          'startLine': 1
                        }
                      }
                    ...
                    'parameters': [
                      {
                        ...
                        'sourceInformation': {
                          'endColumn': 5,
                          'endLine': 1,
                          'sourceId': 'demo::MyMapping-pureInstanceClassMapping-demo_other_NPerson-name3--2',
                          'startColumn': 2,
                          'startLine': 1
                        }
                      }
