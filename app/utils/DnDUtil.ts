...
import { TypeTreeNodeData, PackageTreeNodeData } from './TreeUtil';
...
export enum DND_TYPE {
  ...
  PROJECT_EXPLORER_DIAGRAM = 'PROJECT_EXPLORER_DIAGRAM',
...
export class TypeDragSource {
  ...
  constructor(type: DND_TYPE, data: TypeTreeNodeData) {
    this.data = data;
    this.type = type;
  }
}
...
export class ElementDragSource {
  ...
  constructor(type: DND_TYPE, data: PackageTreeNodeData) {
    this.data = data;
    this.type = type;
  }
}
...
export class MappingElementDragSource {
  ...
  constructor(type: DND_TYPE, data: MappingElement) {
    this.data = data;
    this.type = type;
  }
}
