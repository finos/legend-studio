...
import type { PrimitiveType } from '@finos/legend-graph';
import { hashArray, type Hashable } from '@finos/legend-shared';
import { FLAT_DATA_STORE_HASH_STRUCTURE } from '../../../../../../ESFlatData_ModelUtils.js';
import type { FlatDataSection } from './ESFlatData_FlatDataSection.js';
...
export class FlatDataBoolean extends FlatDataDataType implements Hashable {
  ...
  get hashCode(): string {
    return hashArray([
      FLAT_DATA_STORE_HASH_STRUCTURE.FLAT_DATA_BOOLEAN,
      this.trueString ?? '',
      this.falseString ?? '',
    ]);
  }
...
export class FlatDataString extends FlatDataDataType implements Hashable {
  get hashCode(): string {
    return hashArray([FLAT_DATA_STORE_HASH_STRUCTURE.FLAT_DATA_STRING]);
  }
}

export class FlatDataNumber extends FlatDataDataType implements Hashable {
  get hashCode(): string {
    return hashArray([FLAT_DATA_STORE_HASH_STRUCTURE.FLAT_DATA_NUMBER]);
  }
}

export class FlatDataInteger extends FlatDataNumber implements Hashable {
  override get hashCode(): string {
    return hashArray([FLAT_DATA_STORE_HASH_STRUCTURE.FLAT_DATA_INTEGER]);
  }
}

export class FlatDataFloat extends FlatDataNumber implements Hashable {
  override get hashCode(): string {
    return hashArray([FLAT_DATA_STORE_HASH_STRUCTURE.FLAT_DATA_FLOAT]);
  }
}

export class FlatDataDecimal extends FlatDataNumber implements Hashable {
  override get hashCode(): string {
    return hashArray([FLAT_DATA_STORE_HASH_STRUCTURE.FLAT_DATA_DECIMAL]);
  }
}
...
export class FlatDataDate extends FlatDataDataType implements Hashable {
  ...
  get hashCode(): string {
    return hashArray([
      FLAT_DATA_STORE_HASH_STRUCTURE.FLAT_DATA_DATE,
      this.dateFormat ?? '',
      this.timeZone ?? '',
    ]);
  }
...
export class FlatDataDateTime extends FlatDataDate implements Hashable {
  override get hashCode(): string {
    return hashArray([
      FLAT_DATA_STORE_HASH_STRUCTURE.FLAT_DATA_DATE_TIME,
      this.dateFormat ?? '',
      this.timeZone ?? '',
    ]);
  }
...
export class FlatDataStrictDate extends FlatDataDate implements Hashable {
  override get hashCode(): string {
    return hashArray([
      FLAT_DATA_STORE_HASH_STRUCTURE.FLAT_DATA_STRICT_DATE,
      this.dateFormat ?? '',
      this.timeZone ?? '',
    ]);
  }
...
export class FlatDataRecordField implements Hashable {
  ...
  get hashCode(): string {
    return hashArray([
      FLAT_DATA_STORE_HASH_STRUCTURE.FLAT_DATA_RECORD_FIELD,
      this.label,
...
export class FlatDataRecordType extends FlatDataDataType implements Hashable {
  ...
  get hashCode(): string {
    return hashArray([
      FLAT_DATA_STORE_HASH_STRUCTURE.FLAT_DATA_RECORD_TYPE,
  ...
  implements Hashable
{
  ...
  override get hashCode(): string {
    return hashArray([
      FLAT_DATA_STORE_HASH_STRUCTURE.FLAT_DATA_ROOT_RECORD_TYPE,
      hashArray(this.fields),
    ]);
  }
}
