...
import { makeObservable, observable, computed, override } from 'mobx';
...
import type { EmbeddedFlatDataPropertyMapping } from '../../../models/metamodels/pure/model/store/flatData/mapping/ESFlatData_EmbeddedFlatDataPropertyMapping.js';
...
import {
  ...
  FlatDataRecordType,
  FlatDataString,
} from '../../../models/metamodels/pure/model/store/flatData/model/ESFlatData_FlatDataDataType.js';
import type { FlatDataProperty } from '../../../models/metamodels/pure/model/store/flatData/model/ESFlatData_FlatDataProperty.js';
import type { FlatDataSection } from '../../../models/metamodels/pure/model/store/flatData/model/ESFlatData_FlatDataSection.js';
import type { FlatDataSectionReference } from '../../../models/metamodels/pure/model/store/flatData/model/ESFlatData_FlatDataSectionReference.js';
import type { RootFlatDataRecordTypeReference } from '../../../models/metamodels/pure/model/store/flatData/model/ESFlatData_RootFlatDataRecordTypeReference.js';
