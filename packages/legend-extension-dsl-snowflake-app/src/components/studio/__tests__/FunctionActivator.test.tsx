...
import { TEST_DATA__roundtrip } from '../../../graph-manager/__tests__/TEST_DATA__DSL_SnowflakeApp_Roundtrip.js';
...
import { DSL_SnowflakeApp_GraphManagerPreset } from '../../../graph-manager/DSL_SnowflakeApp_GraphManagerPreset.js';
...
pluginManager
  ...
  .usePlugins([new DSL_SnowflakeApp_LegendStudioApplicationPlugin()])
  .install();
