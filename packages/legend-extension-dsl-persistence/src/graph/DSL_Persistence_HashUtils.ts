...
export enum PERSISTENCE_HASH_STRUCTURE {
  ...
  // test assertion
  ALL_ROWS_EQUIVALENT_TO_JSON = 'ALL_ROWS_EQUIVALENT_TO_JSON',
  ALL_ROWS_EQUIVALENT_TO_JSON_ASSERT_FAIL = 'ALL_ROWS_EQUIVALENT_TO_JSON_ASSERT_FAIL',
  ACTIVE_ROWS_EQUIVALENT_TO_JSON = 'ACTIVE_ROWS_EQUIVALENT_TO_JSON',
  ACTIVE_ROWS_EQUIVALENT_TO_JSON_ASSERT_FAIL = 'ACTIVE_ROWS_EQUIVALENT_TO_JSON_ASSERT_FAIL',
}
