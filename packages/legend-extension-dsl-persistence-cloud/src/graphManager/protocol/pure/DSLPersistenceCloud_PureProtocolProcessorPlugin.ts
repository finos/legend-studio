...
import { AwsGluePersistencePlatform } from '../../../graph/metamodel/pure/model/packageableElements/persistence/cloud/DSLPersistenceCloud_AwsGluePersistencePlatform.js';
