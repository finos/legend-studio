 ...
 * data products with no taxonomy classification.
 */
export const buildUndefinedTaxonomyNode = (): TaxonomyNode => ({
  id: TAXONOMY_UNDEFINED_NODE_ID,
  label: TAXONOMY_UNDEFINED_NODE_LABEL,
  count: 0,
  children: [],
});
...
export const matchesUndefinedTaxonomyNode = (searchTerm: string): boolean =>
  TAXONOMY_UNDEFINED_NODE_LABEL.toLowerCase().includes(
