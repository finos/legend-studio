...
import { LakehousePendingTasksViewer } from '../../../stores/lakehouse/entitlements/LakehousePendingTasksViewer.js';
...
type TaksProps = {
  currentViewer: LakehousePendingTasksViewer;
};

export const LakehouseEntitlementsTasks = withAuth(
  observer((props: TaksProps) => {
    const { currentViewer } = props;
    const state = currentViewer.state;
    const tasks = currentViewer.tasks;
...
export const LakehouseEntitlements = withLakehouseEntitlementsStore(
  observer(() => {
    ...
    const renderCurrentViewer = (): React.ReactNode => {
      ...
      if (currentViewer instanceof LakehousePendingTasksViewer) {
        return <LakehouseEntitlementsTasks currentViewer={currentViewer} />;
