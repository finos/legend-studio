...
export enum LEGEND_MARKETPLACE_APP_EVENT {
  ...
  ADVANCED_SEARCH_ORDERS = 'marketplace.advanced-search.orders',
  ADVANCED_SEARCH_ORDERS_FAILURE = 'marketplace.advanced-search.orders.failure',
  CLEAR_ADVANCED_ORDER_SEARCH = 'marketplace.clear.advanced-order-search',
  PAGINATE_ADVANCED_ORDER_SEARCH = 'marketplace.paginate.advanced-order-search',
  CHANGE_ADVANCED_ORDER_SEARCH_PAGE_SIZE = 'marketplace.change.advanced-order-search.page-size',
  TOGGLE_ALL_ORDERS = 'marketplace.toggle.all-orders',
