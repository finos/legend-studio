...
export const LEGEND_MARKETPLACE_ROUTE_PATTERN = Object.freeze({
  ...
  LAKEHOUSE_SANDBOX_DATAPRODUCT: `/lakehouse/dataProduct/sandbox/:${LEGEND_MARKETPLACE_ROUTE_PATTERN_TOKEN.INGEST_SERVER_URL}/:${LEGEND_MARKETPLACE_ROUTE_PATTERN_TOKEN.DATA_PRODUCT_PATH}`,
