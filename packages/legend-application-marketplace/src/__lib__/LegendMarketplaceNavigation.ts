...
export const LEGEND_MARKETPLACE_ROUTE_PATTERN = Object.freeze({
  ...
  LAKEHOUSE: '/',
  LAKEHOUSE_SEARCH_RESULTS: '/results',
  LAKEHOUSE_ENTITLEMENTS: '/entitlements',
  LAKEHOUSE_PRODUCT: `/dataProduct/deployed/:${LEGEND_MARKETPLACE_ROUTE_PATTERN_TOKEN.DATA_PRODUCT_ID}/:${LEGEND_MARKETPLACE_ROUTE_PATTERN_TOKEN.DEPLOYMENT_ID}`,
  TERMINAL_PRODUCT: `/terminal/terminalProduct/:${LEGEND_MARKETPLACE_ROUTE_PATTERN_TOKEN.TERMINAL_ID}`,
  LAKEHOUSE_SDLC_PRODUCT: `/dataProduct/:${LEGEND_MARKETPLACE_ROUTE_PATTERN_TOKEN.GAV}/:${LEGEND_MARKETPLACE_ROUTE_PATTERN_TOKEN.DATA_PRODUCT_PATH}`,
