...
export abstract class QueryInfoState {
  queryStore: QueryEditorStore;

  constructor(queryStore: QueryEditorStore) {
...
export class ExistingQueryInfoState extends QueryInfoState {
  ...
  constructor(queryStore: QueryEditorStore, query: LightQuery) {
    super(queryStore);
...
export class QueryEditorStore {
  ...
  *setupExistingQueryInfoState(
    ...
    try {
      ...
      yield flowResult(this.initialize());
