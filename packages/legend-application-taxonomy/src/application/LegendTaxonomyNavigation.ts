...
export const LEGEND_TAXONOMY_ROUTE_PATTERN = Object.freeze({
  ...
  STANDALONE_DATA_SPACE_VIEWER: `/dataspace/:${LEGEND_TAXONOMY_ROUTE_PATTERN_TOKEN.GAV}/:${LEGEND_TAXONOMY_ROUTE_PATTERN_TOKEN.DATA_SPACE_PATH}`,
});
...
export type LegendTaxonomyStandaloneDataSpaceViewerPathParams = {
  [LEGEND_TAXONOMY_ROUTE_PATTERN_TOKEN.GAV]: string;
  [LEGEND_TAXONOMY_ROUTE_PATTERN_TOKEN.DATA_SPACE_PATH]: string;
};
