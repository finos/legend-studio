...
export abstract class QueryEditorStore {
  ...
  *buildGraph(): GeneratorFn<void> {
  ...
  async buildGraphAndDataspaceAnalyticsResult(
    ...
    let dataSpaceAnalysisResultValue;
    ...
    if (
      ...
      try {
        ...
        stopWatch.record(GRAPH_MANAGER_EVENT.INITIALIZE_GRAPH_SYSTEM__SUCCESS);
        const dependency_buildReport = createGraphBuilderReport();
        const { dataSpaceAnalysisResult, isMiniGraphSuccess } =
        ...
        dataSpaceAnalysisResultValue = dataSpaceAnalysisResult;
        buildFullGraph = !isMiniGraphSuccess;
    ...
    return {
      dataSpaceAnalysisResult: dataSpaceAnalysisResultValue,
      isLightGraphEnabled,
    };
  }
}
