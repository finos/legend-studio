...
import { QueryBuilderAggregateColumnState } from '../../../stores/query-builder/fetch-structure/projection/aggregation/QueryBuilderAggregationState.js';
...
} from '../../../stores/query-builder/explorer/QueryFunctionsExplorerState.js';
import { DEFAULT_LAMBDA_VARIABLE_NAME } from '../../../stores/query-builder/QueryBuilderConfig.js';
import { QueryBuilderPostFilterTreeConditionNodeData } from '../../../stores/query-builder/fetch-structure/projection/post-filter/QueryBuilderPostFilterState.js';
import { filterByType } from '@finos/legend-shared';
import type { QueryBuilderAggregateOperator } from '../../../stores/query-builder/fetch-structure/projection/aggregation/QueryBuilderAggregateOperator.js';
import type { QueryBuilderProjectionState } from '../../../stores/query-builder/fetch-structure/projection/QueryBuilderProjectionState.js';
