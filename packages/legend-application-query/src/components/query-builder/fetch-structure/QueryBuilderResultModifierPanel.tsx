...
import {
  COLUMN_SORT_TYPE,
  SortColumnState,
} from '../../../stores/query-builder/fetch-structure/projection/QueryResultSetModifierState.js';
import type { QueryBuilderProjectionColumnState } from '../../../stores/query-builder/fetch-structure/projection/QueryBuilderProjectionColumnState.js';
