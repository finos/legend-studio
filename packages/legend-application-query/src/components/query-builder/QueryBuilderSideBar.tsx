...
import { ClassQueryBuilderState } from '../../stores/query-builder/workflows/ClassQueryBuilderState.js';
...
const QueryClassSelector = observer(
  (props: {
    queryBuilderState: QueryBuilderState;
    classes: Class[];
...
const UnknownQueryBuilderSetup = observer(
...
const QueryBuilderSetupPanelContent = observer(
  (props: { queryBuilderState: QueryBuilderState }) => {
    const { queryBuilderState } = props;

    if (queryBuilderState instanceof ClassQueryBuilderState) {
      return <ClassQueryBuilderSetup queryBuilderState={queryBuilderState} />;
    }
    return <UnknownQueryBuilderSetup queryBuilderState={queryBuilderState} />;
  },
);
...
export const QueryBuilderSidebar = observer(
  (props: {
    ...
    return (
      <div className="query-builder__side-bar">
        <div
