...
} from '../../../stores/query-builder/filter/QueryBuilderFilterState.js';
...
import type { QueryBuilderFilterOperator } from '../../../stores/query-builder/filter/QueryBuilderFilterOperator.js';
