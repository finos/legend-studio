...
export const TEST_DATA__DSL_DataSpace_LakehouseFallback_AnalyticsResult = {
  ...
  executables: [
    ...
    },
    {
      info: {
        ...
        id: '2',
        query:
          "|domain::COVIDData.all()->project([x: domain::COVIDData[1]|$x.fips], ['Fips'])",
      },
      result: {
        _type: 'tds',
        columns: [
...
export const TEST_DATA__DSL_DataSpace_MappingProvider_Entities = [
  {
    path: 'domain::Demographics',
    content: {
      _type: 'class',
  ...
  {
    path: 'domain::CovidDataProduct',
    content: {
      _type: 'dataProduct',
      name: 'CovidDataProduct',
      package: 'domain',
      title: 'COVID Data Product',
      description: 'Entitled Lakehouse surface for the COVID mapping.',
      accessPointGroups: [
        {
          _type: 'modelAccessPointGroup',
          id: 'covidMapg',
          title: 'COVID model access',
          accessPoints: [],
          diagrams: [],
          featuredElements: [],
          stereotypes: [],
