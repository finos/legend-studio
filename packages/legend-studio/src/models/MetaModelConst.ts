...
export enum CORE_HASH_STRUCTURE {
  ...
  REALTIONAL_PROPERTY_MAPPPING = 'REALTIONAL_PROPERTY_MAPPPING',
  EMBEDDED_REALTIONAL_PROPERTY_MAPPPING = 'EMBEDDED_REALTIONAL_PROPERTY_MAPPPING',
  OTHERWISE_EMBEDDED_REALTIONAL_PROPERTY_MAPPPING = 'OTHERWISE_EMBEDDED_REALTIONAL_PROPERTY_MAPPPING',
