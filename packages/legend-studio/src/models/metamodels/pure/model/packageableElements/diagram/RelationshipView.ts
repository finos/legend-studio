...
import { hashArray, changeEntry } from '@finos/legend-studio-shared';
...
import { ClassViewExplicitReference } from '../../../model/packageableElements/diagram/ClassViewReference';
...
export class RelationshipView implements Hashable {
  ...
  get hashCode(): string {
    return hashArray([
      CORE_HASH_STRUCTURE.RELATIONSHIP_VIEW,
