...
import { OptionalPackageableElementExplicitReference } from '../../model/packageableElements/PackageableElementReference';
import type {
  ValueSpecification,
  ValueSpecificationVisitor,
} from '../../model/valueSpecification/ValueSpecification';
