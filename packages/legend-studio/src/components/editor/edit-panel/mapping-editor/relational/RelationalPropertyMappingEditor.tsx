...
import { relationalPropertyMapping_setTransformer } from '../../../../../stores/DSLRelational_ModifierHelper';
...
const EnumerationPropertyMappingEditor = observer(
  (props: {
    ...
    const handleSelectionChange = (
      ...
      relationalPropertyMapping_setTransformer(propertyMapping, val?.value);
    // Walker
    const visit = (): void => {
