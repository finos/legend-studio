...
export const STUDIO_HOTKEY_MAP = Object.freeze({
  [STUDIO_HOTKEY.SYNC_WITH_WORKSPACE]: 'ctrl+s',
  [STUDIO_HOTKEY.CREATE_ELEMENT]: 'ctrl+shift+n',
  [STUDIO_HOTKEY.OPEN_ELEMENT]: 'ctrl+p',
  [STUDIO_HOTKEY.TOGGLE_MODEL_LOADER]: 'f2',
  [STUDIO_HOTKEY.TOGGLE_TEXT_MODE]: 'f8',
  [STUDIO_HOTKEY.COMPILE]: 'f9',
  [STUDIO_HOTKEY.GENERATE]: 'f10',
  [STUDIO_HOTKEY.TOGGLE_AUX_PANEL]: 'ctrl+`',
  [STUDIO_HOTKEY.TOGGLE_SIDEBAR_EXPLORER]: 'ctrl+shift+x',
  [STUDIO_HOTKEY.TOGGLE_SIDEBAR_CHANGES]: 'ctrl+shift+g',
  [STUDIO_HOTKEY.TOGGLE_SIDEBAR_WORKSPACE_REVIEW]: 'ctrl+shift+m',
  [STUDIO_HOTKEY.TOGGLE_SIDEBAR_WORKSPACE_UPDATER]: 'ctrl+shift+u',
});
