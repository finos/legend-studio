...
import type { LegendApplicationContextualDocumentationConfig } from '@finos/legend-application';
...
export const CORE_CONTEXTUAL_DOCUMENTATION_CONFIG: LegendApplicationContextualDocumentationConfig =
  {
