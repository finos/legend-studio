...
import type { V1_RestServiceOwnership } from './V1_RestServiceOwnership.js';

export class V1_RestService extends V1_FunctionActivator {
  documentation: string | undefined;
  ownership: V1_RestServiceOwnership | undefined;
  pattern!: string;
  autoActivateUpdates: boolean | undefined;
  storeModel: boolean | undefined;
  generateLineage: boolean | undefined;
  declare activationConfiguration: V1_RestServiceDeploymentConfiguration;
