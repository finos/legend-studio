...
import { V1_rawBaseExecutionContextModelSchema } from '../../transformation/pureProtocol/serializationHelpers/V1_RawValueSpecificationSerializationHelper';

export class V1_ExecuteMappingTestInput {
  ...
  static readonly serialization = new SerializationFactory(
    createModelSchema(V1_ExecuteMappingTestInput, {
