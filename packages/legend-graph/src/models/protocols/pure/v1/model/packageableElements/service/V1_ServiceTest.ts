...
import { V1_ServiceTest_Legacy } from './V1_ServiceTest_Legacy';
...
export class V1_SingleExecutionTest
  extends V1_ServiceTest_Legacy
  implements Hashable
{
  data!: string;
...
export class V1_MultiExecutionTest
  extends V1_ServiceTest_Legacy
  implements Hashable
{
