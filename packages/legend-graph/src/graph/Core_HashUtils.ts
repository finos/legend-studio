...
export enum CORE_HASH_STRUCTURE {
  ...
  DATA_PRODUCT_TEST_SUITE = 'DATA_PRODUCT_TEST_SUITE',
  DATA_PRODUCT_ACCESS_POINT_TEST = 'DATA_PRODUCT_ACCESS_POINT_TEST',
  DATA_PRODUCT_TEST_DATA = 'DATA_PRODUCT_TEST_DATA',
  INGEST_TEST_SUITE = 'INGEST_TEST_SUITE',
  INGEST_MAT_VIEW_TEST = 'INGEST_MAT_VIEW_TEST',
  BASE_DATA_RESOLVER = 'BASE_DATA_RESOLVER',
  REFERENCE_DATA_RESOLVER = 'REFERENCE_DATA_RESOLVER',
  ...
  EQUAL_TO_RELATION = 'EQUAL_TO_RELATION',
  EQUAL_TO_RELATION_ASSERT_FAIL = 'EQUAL_TO_RELATION_ASSERT_FAIL',
  ...
  ACCESSOR_INSTANCE_VALUE = 'ACCESSOR_INSTANCE_VALUE',
  ...
  MODEL_JOIN_ASSOCIATION_IMPLEMENTATION = 'MODEL_JOIN_ASSOCIATION_IMPLEMENTATION',
  ...
  RELATION_ROW_TEST_DATA = 'RELATION_ROW_TEST_DATA',
  ...
  AVAILABILITY_TEST_SUITE = 'AVAILABILITY_TEST_SUITE',
  AVAILABILITY_BARRIER_TEST = 'AVAILABILITY_BARRIER_TEST',
  ...
  DATABASE_INCLUDE_STORE = 'DATABASE_INCLUDE_STORE',
  ...
  RELATION_FUNCTION_EMBEDDED_PROPERTY_MAPPING = 'RELATION_FUNCTION_EMBEDDED_PROPERTY_MAPPING',
  INLINE_EMBEDDED_RELATION_FUNCTION_PROPERTY_MAPPING = 'INLINE_EMBEDDED_RELATION_FUNCTION_PROPERTY_MAPPING',
  ...
  DATA_PRODUCT_NATIVE_MODEL_EXECUTION_CONTEXT = 'DATA_PRODUCT_NATIVE_MODEL_EXECUTION_CONTEXT',
  DATA_PRODUCT_NATIVE_MODEL_ACCESS = 'DATA_PRODUCT_NATIVE_MODEL_ACCESS',
  DATA_PRODUCT_SAMPLE_QUERY = 'DATA_PRODUCT_SAMPLE_QUERY',
  DATA_PRODUCT_PACKAGEABLE_ELEMENT_SAMPLE_QUERY = 'DATA_PRODUCT_PACKAGEABLE_ELEMENT_SAMPLE_QUERY',
  DATA_PRODUCT_INLINE_SAMPLE_QUERY = 'DATA_PRODUCT_INLINE_SAMPLE_QUERY',
  ...
  INTERNAL__UNKNOWN_DATA_PRODUCT_ICON = 'INTERNAL__UNKNOWN_DATA_PRODUCT_ICON',
  DATA_PRODUCT_OWNER = 'DATA_PRODUCT_OWNER',
  APP_DIR_NODE = 'APP_DIR_NODE',
  EMAIL = 'EMAIL',
  LAKEHOUSE_ACCESS_POINT = 'LAKEHOUSE_ACCESS_POINT',
  UNKNOWN_ACCESS_POINT = 'UNKNOWN_ACCESS_POINT',
  FUNCTION_ACCESS_POINT = 'FUNCTION_ACCESS_POINT',
  DATA_PRODUCT_TYPE = 'DATA_PRODUCT_TYPE',
  MAPPING_INCLUDE_DATAPRODUCT = 'MAPPING_INCLUDE_DATAPRODUCT',
  DATA_PRODUCT_EXPERTISE = 'DATA_PRODUCT_EXPERTISE',
  DATA_PRODUCT_OPERATIONAL_METADATA = 'DATA_PRODUCT_OPERATIONAL_METADATA',
  DATA_PRODUCT_SECURE_VIEW = 'DATA_PRODUCT_SECURE_VIEW',

  // ---------------------------------- Compute -------------------------------------------

  COMPUTE = 'COMPUTE',
  COMPUTE_APP_DIR_OWNER = 'COMPUTE_APP_DIR_OWNER',
  SNOWFLAKE_COMPUTE_SPECIFICATION = 'SNOWFLAKE_COMPUTE_SPECIFICATION',
  DATABRICKS_COMPUTE_SPECIFICATION = 'DATABRICKS_COMPUTE_SPECIFICATION',
  INTERNAL__UNKNOWN_COMPUTE_SPECIFICATION = 'INTERNAL__UNKNOWN_COMPUTE_SPECIFICATION',
  DATABRICKS_TAG = 'DATABRICKS_TAG',
}
