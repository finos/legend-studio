...
export enum CORE_HASH_STRUCTURE {
  ...
  INTERNAL__UNKNOWN_INSTANCE_SET_IMPLEMENTATION = 'INTERNAL__UNKNOWN_INSTANCE_SET_IMPLEMENTATION',
  ...
  MAPPING_TEST_DATA_SUITE = 'MAPPING_TEST_DATA_SUITE',
  MAPPING_TEST_QUERY_SUITE = 'MAPPING_TEST_QUERY_SUITE',
  MAPPING_TEST = 'MAPPING_TEST',
  MAPPING_QUERY_TEST = 'MAPPING_QUERY_TEST',
  MAPPING_DATA_TEST = 'MAPPING_DATA_TEST',
