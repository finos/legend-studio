...
export class INTERNAL__UnknownSetImplementation
  ...
  implements Hashable
{
  ...
  override get hashCode(): string {
    return hashArray([
      CORE_HASH_STRUCTURE.INTERNAL__UNKNOWN_CLASS_MAPPING,
  ...
  accept_SetImplementationVisitor<T>(visitor: SetImplementationVisitor<T>): T {
    return visitor.visit_INTERNAL__UnknownSetImplementation(this);
  }
}
