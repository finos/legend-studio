...
export enum CORE_HASH_STRUCTURE {
  ...
  FUNCTION_TEST_PARAMETER_COMPLEX_VALUE = 'FUNCTION_TEST_PARAMETER_COMPLEX_VALUE',
  FUNCTION_TEST_PARAMETER_PRIMITIVE_VALUE = 'FUNCTION_TEST_PARAMETER_PRIMITIVE_VALUE',
  // runtime
  RUNTIME = 'RUNTIME',
