...
import type { LegendPureIDEApplicationPlugin } from '../stores/LegendPureIDEApplicationPlugin.js';

export class LegendPureIDEPluginManager
  extends LegendApplicationPluginManager<LegendPureIDEApplicationPlugin>
  implements GraphManagerPluginManager
{
  ...
  static create(): LegendPureIDEPluginManager {
