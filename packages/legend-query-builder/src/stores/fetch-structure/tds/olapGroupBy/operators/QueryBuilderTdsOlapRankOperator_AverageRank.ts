...
export class QueryBuilderTDSOlapRankOperator_AverageRank extends QueryBuilderTDSOlapOperator {
  getLabel(): string {
    return 'average rank';
  }
  ...
  get hashCode(): string {
    return hashArray([QUERY_BUILDER_HASH_STRUCTURE.OLAP_OPERATOR_DENSE_RANK]);
  }
