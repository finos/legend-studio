...
export class MapperPostProcessorEditorState {
  ...
  constructor(
    ...
    console.log('class: mapper post processore editor state');

    this.selectedMapper = selectedMapper;
    this.connectionValueState = connectionValueState;
    this.selectedPostP = selectedPostP;
  }
  setselectedMapper(val: Mapper): void {
    console.log('yes the seleected mapper different frfr now');
