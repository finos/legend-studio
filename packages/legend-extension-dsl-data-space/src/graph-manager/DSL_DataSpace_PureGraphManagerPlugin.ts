...
export const PURE_POWERBI_ARTIFACT_GENERATION_PROFILE_PATH = 'meta::external::powerbi::profiles::PowerBIArtifactGeneration';
...
export class DSL_DataSpace_PureGraphManagerPlugin extends PureGraphManagerPlugin {
  ...
  override getExtraExposedSystemElementPath(): string[] {
    return [PURE_ENTERPRISE_PROFILE_PATH, PURE_DATA_SPACE_INFO_PROFILE_PATH, PURE_POWERBI_ARTIFACT_GENERATION_PROFILE_PATH];
  }
