...
import { LegendCatalogWebApplication } from '@finos/legend-application-catalog-bootstrap';
import config from '../catalog.config.js';
import './index.css';
...
LegendCatalogWebApplication.run(config.baseUrl);
