...
import { LegendMarketplaceWebApplication } from '@finos/legend-application-marketplace-bootstrap';
import config from '../marketplace.config.js';
import './index.css';
...
LegendMarketplaceWebApplication.run(config.baseUrl);
