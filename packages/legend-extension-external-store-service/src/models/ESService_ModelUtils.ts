...
export enum SERVICE_STORE_HASH_STRUCTURE {
  ...
  SERVICE_STORE_ELEMENT = 'SERVICE_STORE_ELEMENT',
  SERVICE = 'SERVICE',
  ...
  //Mapping
  LOCAL_MAPPING_PROPERTY = 'LOCAL_MAPPING-PROPERTY',
  SERVICE_MAPPING = 'SERVICE_MAPPING',
  SERVICE_PARAMETER_MAPPING = 'SERVICE_PARAMETER_MAPPING',
  ...
  //Connection
  SERVICE_STORE_CONNECTION = 'SERVICE-STORE_CONNECTION',
}
