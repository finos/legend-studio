...
import {
  DATA_QUALITY_RELATION_COMPARISON_EDITOR_TAB,
      ...
      <Panel>
        ...
        <div className="panel__header relation-validation-config-editor__tabs__header">
          <div className="relation-validation-config-editor__tabs">
            {Object.values(DATA_QUALITY_RELATION_COMPARISON_EDITOR_TAB).map(
              (tab) => (
                <div
                  key={tab}
                  onClick={(): void => state.setSelectedTab(tab)}
        ...
        <PanelContent>
          {state.selectedTab ===
            DATA_QUALITY_RELATION_COMPARISON_EDITOR_TAB.TESTS && (
            <DataQualityTestsEditor testableState={state.testableState} />
          )}
          {state.selectedTab ===
            DATA_QUALITY_RELATION_COMPARISON_EDITOR_TAB.DEFINITION && (
            <>
              ...
              <div className="data-quality-relation-comparison-editor__panel__content__form">
                ...
                {hasNoOverlappingColumns && (
                  <div className="data-quality-relation-comparison-editor__column-overlap-warning">
                    ...
                    <span className="data-quality-relation-comparison-editor__column-overlap-warning__message">
                      ...
                      queries. The Keys and Columns to Compare selectors require
                      at least one common column name across both queries.
                    </span>
                  </div>
                )}
                <PanelFormSection>
                ...
                <PanelFormSection>
                  ...
                  <div className="panel__content__form__section__header__prompt">
                    If a source hash column already exists you can specify it
                    here (optional)
                  </div>
                  <CustomSelectorInput
                ...
                <PanelFormSection>
                  ...
                  <div className="panel__content__form__section__header__prompt">
                    If a target hash column already exists you can specify it
                    here (optional)
                  </div>
                  <CustomSelectorInput
