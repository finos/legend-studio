...
export enum DATA_QUALITY_HASH_STRUCTURE {
  ...
  DATA_QUALITY_RELATION_VALIDATION_TEST_SUITE = 'DATA_QUALITY_RELATION_VALIDATION_TEST_SUITE',
  DATA_QUALITY_RELATION_VALIDATION_TEST = 'DATA_QUALITY_RELATION_VALIDATION_TEST',
  DATA_QUALITY_RELATION_VALIDATION_TEST_DATA = 'DATA_QUALITY_RELATION_VALIDATION_TEST_DATA',
  DATA_QUALITY_RELATION_COMPARISON_TEST_SUITE = 'DATA_QUALITY_RELATION_COMPARISON_TEST_SUITE',
  DATA_QUALITY_RELATION_COMPARISON_TEST = 'DATA_QUALITY_RELATION_COMPARISON_TEST',
  DATA_QUALITY_RELATION_COMPARISON_TEST_DATA = 'DATA_QUALITY_RELATION_COMPARISON_TEST_DATA',
}
